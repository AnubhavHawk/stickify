...
const Header = () => {
  ...
  return (
    <div className="sticky top-4 z-20">
      <nav className="navbar navbar-expand-lg bg-black text-white rounded d-flex justify-content-between">
        <div className="container-fluid">
          <Link to="/" className="text-white">
            <span className="text-light" style={{fontSize: "30px", letterSpacing: "3px"}}>Stickify</span>
          </Link>
          <div>
          ...
          <div>
            <div className="d-flex align-items-center justify-content-between">
              <Link to="/#all-products" text="Products" className="text-light mr-5" >Products</Link>
